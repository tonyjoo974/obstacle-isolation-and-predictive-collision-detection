...
def getModelState():
    ...
    try:
        ...
        modelState = serviceResponse(model_name='actor1')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description = 'Set the x, y position of the actor')

    x_default = 0
    y_default = 0

    parser.add_argument('--x', type = float, help = 'x position of the actor.', default = x_default)
    parser.add_argument('--y', type = float, help = 'y position of the actor.', default = y_default)
