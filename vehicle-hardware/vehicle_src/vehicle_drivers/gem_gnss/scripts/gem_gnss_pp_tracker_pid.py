...
class PurePursuit(object):
    ...
    def start_pp(self):
        ...
        t_react = 0.00
        pt = predict_track()
        pt.updateMotionPara(self.steer_cmd.angular_position / 180 * np.pi / 2, self.speed, self.accel_cmd.f64_cmd)
        ...
        while not rospy.is_shutdown():
            ...
            if not brake:
                ...
                if set_acc > 0:
                    text = 'Braking'
                    set_acc = max(set_acc - 0.2, 0)
                else:
                    set_acc = 0
                """
                set_acc = 0.3
                
            if set_acc > self.max_accel:
                set_acc = self.max_accel
            ...
            self.accel_cmd.f64_cmd = set_acc
