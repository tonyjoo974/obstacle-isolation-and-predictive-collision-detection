...
class predict_track():
    def __init__(self):
        ...
        self.sub_bird = rospy.Subscriber("/gem/PedestrianAnnotate", Image, self.img_callback, queue_size=1)
    ...
    def predictTrajectory(self, img):
        ...
        while 0 < y_pixel < height and 0 < x_pixel < width and itr < 30 and self.velocity > 0:
