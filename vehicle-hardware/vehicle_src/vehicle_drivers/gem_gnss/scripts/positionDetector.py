...
class PositionDetector:
    def __init__(self, resolution):
        ...
        self.birdsEyeSub = rospy.Subscriber("/gem/BirdsEye", Image, self.detectPosition, queue_size=1)
        self.debugPub = rospy.Publisher("/gem/Debug", Image, queue_size=1)
        self.finalPub = rospy.Publisher("/gem/PedestrianAnnotate", Image, queue_size=1)
