...
class LidarProcessing:
    def __init__(self, resolution=0.1, side_range=(-20., 20.), fwd_range=(-20., 20.),
        ...
        self.__birds_eye_view =  np.zeros((200, 200))

        self.birdsEyeViewPub = rospy.Publisher("/gem/BirdsEye2", Image, queue_size=1)
        self.pointCloudSub = rospy.Subscriber("/gem/velodyne_points", PointCloud2, self.__pointCloudHandler, queue_size=10)
